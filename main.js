...
client.on('message_create', async(msg) => {
    if (msg.fromMe) {
        ...
        } else if (msg.body == ".alive") { // Alive Command
             msg.delete(true)
            client.sendMessage(msg.to, "*Hey! This is me Ultron.* \n The Whatsapp Assistant Of My Master Roldex. \n I am Learning And Adding More Features. \n\n Deploy me from :- https://github.com/r0ld3x/WhatsBot . ")
...
app.get('/', (req, res) => {
    res.send('<h1>This server is powered by Ultron<br><a href="https://github.com/R0ld3x/WhatsBot">https://github.com/r0ld3x/WhatsBot</a></h1>')
})
